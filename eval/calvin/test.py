...
from open_flamingo_train_distributed import init_distributed_device, world_info_from_env
...
def main():
    ...
    if "pi0_cfg" in configs.keys():
        ...
        configs["pi0_cfg"] = configs["pi0_cfg"].replace(old_dir + "/RoboVLMs", new_dir + "/VLM4VLA")
