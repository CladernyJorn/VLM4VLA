...
CUDA_VISIBLE_DEVICES=${device} python eval/simpler/main_inference.py --policy-model ${policy_model} --ckpt-path ${ckpt_path} --config_path ${config_path} --execute_step ${execute_step} \
